...
class MonoKANMonotoneMixer(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.state_embed_dim = getattr(args, "monokan_state_embed_dim", 32)
        ...
        self.hidden_dim = getattr(args, "monokan_hidden_dim", 32)
        self.num_intervals = getattr(args, "monokan_grid", 7)
        ...
        self.q_temperature = getattr(args, "monokan_q_temperature", 1.0)
